...
<html>
    ...
    <body style="background: #eee;">
        ...
        <div style="width: 100%;margin: auto; margin-top: 15px; border: 1px solid #900F1A;padding: 30px; background: #fff;">
            ...
            $db=new Conect_MySql();
                $sql = "SELECT id_tareas, nombre, ap, am, tareas.boleta, titulo, tamano, departamental, nombre_archivo FROM tareas INNER JOIN alumno ON tareas.boleta  = alumno.boleta WHERE departamental = 3 ";
